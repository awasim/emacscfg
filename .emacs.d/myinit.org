...
#+BEGIN_SRC emacs-lisp
  ...
  (defun size-3 ()
    (interactive)
    (set-frame-size (selected-frame) 115 (truncate (/ (* (display-pixel-height) .67) (frame-char-height))))
    (set-frame-position (selected-frame) 740 20))

  (defun size-4 ()
    (interactive)
    (set-frame-size (selected-frame) 185 25)
    (set-frame-position (selected-frame) 20 20))

  (defun size-5 ()
    (interactive)
    (set-frame-size (selected-frame) 185 25)
    (set-frame-position (selected-frame) 20 500))
